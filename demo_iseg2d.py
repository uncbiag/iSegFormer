...
from iseg2d.SimpleClick.isegm.utils import exp
from iseg2d.SimpleClick.isegm.inference import utils
from iseg2d.SimpleClick.interactive_demo.app import InteractiveDemoApp
...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, default="./iseg2d/SimpleClick/config.yml",
