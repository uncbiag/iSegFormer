...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', help='Folders containing input images.')
    parser.add_argument('--video', help='Video file readable by OpenCV.', default='example/example.mp4')
    parser.add_argument('--volume', help='3D medical volumes.')
    ...
    with torch.cuda.amp.autocast(enabled=not args.no_amp):
        ...
        if args.images is not None:
            ...
            print(args.volume)
            images = load_volume(args.volume, args.resolution if args.resolution > 0 else None)
