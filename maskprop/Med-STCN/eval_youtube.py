...
parser.add_argument('--model', default='saves/stcn_retrained_300k.pth')
parser.add_argument('--yv_path', default='../../data/YouTube2018')
...
# palette = Image.open(path.expanduser(yv_path + '/valid/Annotations/0062f687f1/00000.png')).getpalette()
