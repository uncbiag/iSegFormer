...
def evaluate():
    ...
    root_folder = '/playpen-raid2/qinliu'
    gt_folder = f'{root_folder}/data/AbdomenCT-1K/Organ-12-Subset_frames/trainval/Annotations/480p'
    # seg_folder = f'{root_folder}/projects/iSegFormer/maskprop/Med-STCN/results/stcn'
    # seg_folder = f'{root_folder}/projects/iSegFormer/maskprop/Med-STCN/results/stcn_med_abdomen1k_Aug01_22.03.33_ft_s012_10k_cc'
    seg_folder = f'{root_folder}/projects/iSegFormer/maskprop/Med-STCN/results/stcn_med_abdomen1k_Aug01_15.34.08_ft_s012_10k_no_cc'
    dataset_file = f'{root_folder}/data/AbdomenCT-1K/Organ-12-Subset_frames/trainval/ImageSets/val.txt'
